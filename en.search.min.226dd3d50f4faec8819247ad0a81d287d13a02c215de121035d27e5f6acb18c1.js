...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d2fa88d9d08cdd409a969105ab4d5e4851b06f7d24fdcbd894dcd929a92723ec.js',function(){input.required=false;search();});}
