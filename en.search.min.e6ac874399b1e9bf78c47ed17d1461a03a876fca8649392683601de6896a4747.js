...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fb91c433ce6abb990cdaa266b10fab42d7e6289d58e0ba11d3a250c29e0c0bca.js',function(){input.required=false;search();});}
