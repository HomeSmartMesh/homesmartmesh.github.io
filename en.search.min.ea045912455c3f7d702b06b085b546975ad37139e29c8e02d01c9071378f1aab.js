...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f026f09b78fb9ff88166db48aa323de79efc5a1074b8dea5825c4b87ba7b5e7e.js',function(){input.required=false;search();});}
