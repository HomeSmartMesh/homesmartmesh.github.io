...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.250e4981ba1364d5d8e2269b45fcd5ffaeb8d5a28646579298fa1e2cc235cc45.js',function(){input.required=false;search();});}
