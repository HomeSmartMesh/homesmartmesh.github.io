...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ba2cbcdd0bcf9e8fb51b0d07b18808932dd00fb0eaa1a427ddc28efa8a8dc1be.js',function(){input.required=false;search();});}
