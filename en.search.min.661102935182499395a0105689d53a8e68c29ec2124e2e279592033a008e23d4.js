...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.477519dfe27cc1bb9dc929c6835d02a800ac4ba58a904cbdb4889acbbe017976.js',function(){input.required=false;search();});}
