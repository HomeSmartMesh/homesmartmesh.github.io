...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.41eb76cf1934c7243ef045ba7e728e8d0eb74f4d4eff91633991f524c0ca43a1.js',function(){input.required=false;search();});}
