...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c77b9e7738853cefdfad5ca864b7448fe03b43c2d2200adcef16dcad706d9de7.js',function(){input.required=false;search();});}
