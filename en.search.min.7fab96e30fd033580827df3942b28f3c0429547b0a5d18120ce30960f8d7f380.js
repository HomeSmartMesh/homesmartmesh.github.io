...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.65610a881e3e8ddbb88c9fe9c1caa76a351d40b5849123833939e8e6ffa28366.js',function(){input.required=false;search();});}
