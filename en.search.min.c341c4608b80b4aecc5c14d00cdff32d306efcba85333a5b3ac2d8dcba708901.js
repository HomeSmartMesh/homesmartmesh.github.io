...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.78862fecc2eae49c461527dd88af84ad6b9a1312a7d91bab80a4d28aad8ee83e.js',function(){input.required=false;search();});}
