...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3a8ae701fc07f6462b54dc4f9bc4abd2810e6b61a0f40a7cd6c35548391a206d.js',function(){input.required=false;search();});}
