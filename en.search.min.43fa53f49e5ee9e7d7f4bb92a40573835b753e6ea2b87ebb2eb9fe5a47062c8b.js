...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e3d64c2ebfd9110903851fcb24bebba07f7a9d6c2f1a0a4ad8d9ae9003a507ef.js',function(){input.required=false;search();});}
