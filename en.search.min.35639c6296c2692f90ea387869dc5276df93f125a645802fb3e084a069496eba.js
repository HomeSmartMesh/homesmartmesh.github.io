...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d22ac0220053d9a4a2411b267691eb45b7767a522ce15f036d2a76a32f0e5ff0.js',function(){input.required=false;search();});}
