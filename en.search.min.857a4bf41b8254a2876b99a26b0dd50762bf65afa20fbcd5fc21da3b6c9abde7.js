...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.baf0a97d3a896ea9b3b2267cb5e19c8d908635585db4c42a1c684525911156b3.js',function(){input.required=false;search();});}
