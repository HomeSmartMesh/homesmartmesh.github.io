...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b6eddb8b102ceb230e39d7d0dfb4729d7eca04e46f437f7ae89d86aa8b1a0a5d.js',function(){input.required=false;search();});}
