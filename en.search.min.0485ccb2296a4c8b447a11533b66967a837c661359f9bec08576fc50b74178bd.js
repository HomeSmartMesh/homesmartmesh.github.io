...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1928be15db5ffc7202e21bd8caafbee19005bc98bca761d2f1f124cf4c23ea1d.js',function(){input.required=false;search();});}
