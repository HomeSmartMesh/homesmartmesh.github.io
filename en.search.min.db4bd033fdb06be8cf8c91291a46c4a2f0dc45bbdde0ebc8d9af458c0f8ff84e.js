...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f9b3789a004aa3614fd52ea0f36de3bfcff1e7220efe18e23a15110c765fce19.js',function(){input.required=false;search();});}
