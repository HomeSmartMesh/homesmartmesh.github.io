...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.80d91b2305758216a7af0b21839314a2af827c04583992425ec63d7894e963be.js',function(){input.required=false;search();});}
