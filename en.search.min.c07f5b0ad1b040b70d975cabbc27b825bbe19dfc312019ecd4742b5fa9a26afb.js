...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f639a131f95fcca67256919a07c3570d16c34eb3ea314bd1f035cb8fc8cbebc8.js',function(){input.required=false;search();});}
