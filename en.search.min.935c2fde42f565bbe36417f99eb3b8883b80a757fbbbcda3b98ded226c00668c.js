...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3e541d6c1094f1b6e0c5d4492c7333cdaab16809a1142bf997a37f4a2b424351.js',function(){input.required=false;search();});}
