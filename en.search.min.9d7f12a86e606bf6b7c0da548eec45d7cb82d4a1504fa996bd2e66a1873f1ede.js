...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.30b1afb7e36f4357bbaba937e0e11a55e4573416785ed748d1ccb9090bd2a53a.js',function(){input.required=false;search();});}
