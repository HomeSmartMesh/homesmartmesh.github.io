...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.903beb61dcaffec022e6ea4a0402bd21b10e83f9ceac7589429f214a0c63a80f.js',function(){input.required=false;search();});}
