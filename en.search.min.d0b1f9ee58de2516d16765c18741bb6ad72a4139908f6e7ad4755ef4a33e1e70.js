...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2b37a1f7d57c14cfdc2d63a706fc2be0485c0b22956bb733df928ecc6166418f.js',function(){input.required=false;search();});}
