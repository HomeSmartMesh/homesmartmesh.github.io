...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.55b623414aaed0dc2a6675b489c749ef97dfca530aacba721a1250be4167812e.js',function(){input.required=false;search();});}
