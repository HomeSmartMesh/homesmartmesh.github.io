...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.facd367d6bd5add8b59f0c6714acd0ba13fc33879afa4d162898bfb92b96539c.js',function(){input.required=false;search();});}
