...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8682557497bbfe6cbd575fe605ee60650f8ddd86a69dcd99be1d5a0722354402.js',function(){input.required=false;search();});}
