...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.347df5bf4e598cb1b1617727eaaf722aba0b5823d9ddec581bdc0697688320a7.js',function(){input.required=false;search();});}
