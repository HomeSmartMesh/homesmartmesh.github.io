...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7fa78950a9cf29020edf806931dba72050264e155a269eedfd061b78a1d9b3da.js',function(){input.required=false;search();});}
