...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.80204551f3134701210db91f9ced923b6472a153a742dc4c47f3e3e09d4dffcd.js',function(){input.required=false;search();});}
